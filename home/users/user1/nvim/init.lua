...
if ok and m then
    if cb then cb(m) end
        ...
        vim.keymap.set("n", "<leader>pp", function() t.extensions.projects.projects({}) end,
                       { desc = "Project picker" })
        end)
        ...
        if cmp_ok then
            ...
            if luasnip then
                ...
                if lspconfig_ok then
                    ...
                    -- General servers (enabled in extraPackages)
                    local servers = {
                        "lua_ls",
                        "rust_analyzer",
                        "bashls",
                        ...
                        "yamlls",
                        "pyright",
                        -- add more if you enable them in extraPackages: "clangd", "gopls", "tsserver"
                    }
